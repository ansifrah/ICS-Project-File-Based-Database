...
void check_insertRow(vector<string> tokens, vector<string> lower_tok) {
    ...
    // checking whether the table schema file, actually exists in the cwd
    ...
    // Print the rows to be inserted for verification
    cout << "Rows to insert into table '" << table_name << "':" << endl;
    ...
    // list of error codes for insert
    ...
    // getting all the data in the pk column
